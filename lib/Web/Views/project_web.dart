          ...
          children: [
            ...
            VxSwiper(
                ...
                items: [
                  ...
                  //   VxBox(
                  //       child: Text("abc")
                  //   ).gray800.width(context.screenWidth*0.5).height(context.screenHeight*0.4).make(),
                  //
                  //
                  // ),
                  ...
                  VxBox(
                      child: Image.network("https://image.freepik.com/free-psd/app-interface-mock-up-phone-display_23-2148963434.jpg",height: context.screenHeight*0.4,width: context.screenWidth*0.5,fit: BoxFit.cover)
                  ).width(context.screenWidth*0.5).make(),
                  VxBox(
                      child: Image.network("https://image.freepik.com/free-vector/responsive-landing-page-with-faceless-man-working-laptop-3d-start-up-business-elements_1302-25858.jpg",height: context.screenHeight*0.4,width: context.screenWidth*0.5,fit: BoxFit.cover)
                  ).width(context.screenWidth*0.5).make()
                ])
          ],
        ),
